...
const CONNECTORS = [
  ...
  // ── COMING SOON ────────────────────────────────────────────
  {
    ...
    desc: "Read and analyze your Notion pages and databases.",
    status: "soon",
  ...
  },
  {
    ...
    color: "bg-red-50 border-red-200",
    iconBg: "bg-red-100 text-red-600",
    desc: "Search and summarize emails from your Gmail inbox.",
    status: "soon",
    category: "Email",
  },
  {
    ...
    desc: "Search messages and threads from your Slack workspace.",
    status: "soon",
    category: "Messaging",
  },
  {
    ...
    desc: "Access and analyze files stored in your Dropbox.",
    status: "soon",
    category: "Files",
  },
  {
    ...
    desc: "Access documents and files from Microsoft OneDrive.",
    status: "soon",
    category: "Files",
  },
  {
    ...
    color: "bg-gray-50 border-gray-200",
    iconBg: "bg-gray-900 text-white",
    desc: "Search and analyze posts and threads from X (Twitter).",
    status: "soon",
    category: "Social",
  },
  {
    ...
    color: "bg-orange-50 border-orange-200",
    iconBg: "bg-orange-100 text-orange-600",
    desc: "Analyze a full Reddit thread — top comments, discussion, sentiment.",
    status: "soon",
    category: "Social",
  },
  {
    ...
    color: "bg-purple-50 border-purple-200",
    iconBg: "bg-purple-100 text-purple-700",
    desc: "Describe and analyze Figma files and design components.",
    status: "soon",
    category: "Design",
  },
  {
    ...
    desc: "Research companies, funding rounds, investors, and founders.",
    status: "soon",
    category: "Finance",
  },
];

const CATEGORIES = ["All", "Web", "Code", "News", "Files", "Productivity", "Email", "Messaging", "Social", "Design", "Finance"];
